# Contributing to go2pdb

We are excited to have you contribute to go2pdb!
If you have general questions about the code, please  start a thread in the [discussion forum](https://github.com/Electrostatics/go2pdb/discussions). 
Once you have familiarity with the code, you're ready to start contributing:

## Find or create a problem

Find a problem/feature that needs to be resolved in the code [issues](https://github.com/Electrostatics/go2pdb/issues).
...
2. Create a [pull request](https://github.com/Electrostatics/go2pdb/compare?expand=1) and add reviewers (e.g., `sobolevnrm`) to the request.
